...
Веб-приложение для проведения турниров по системе single-elimination (олимпийская система), где пользователь может загружать и настраивать список произвольных объектов, а затем проводить серию матчей один на один, выбирая победителя в каждом противостоянии до определения итогового чемпиона. Решение ориентировано на автономную работу в браузере без регистрации и серверной части, с сохранением данных в локальном хранилище пользователя и возможностью развертывания на GitHub Pages.
...
- **Типы**:
  ...
  ```
  ✅ Моделирование данных — выполнено
...
- **Стили**: CSS Modules, не используем inline-стили.
